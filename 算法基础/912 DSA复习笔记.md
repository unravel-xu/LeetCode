...
[4. 寻找两个正序数组的中位数](https://leetcode.cn/problems/median-of-two-sorted-arrays/) [官方题解](https://www.bilibili.com/video/BV1Xv411z76J/?spm_id_from=333.337.search-card.all.click&vd_source=b404977d131639c9b47b18fe2cc16c2c)给了另一种 $O(\log(\min\{{n_{1},n_{2}}\}))$ d 算法
### 第 K 大元素选择算法
对于在一个无序的数组中找出第K小（大）的元素，目前有很多种方法：
...
5. 部分的快速排序（快速选择算法），每次划分之后判断第k个数在左右哪个部分，然后递归对应的部分
