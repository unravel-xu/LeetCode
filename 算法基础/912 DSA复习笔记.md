...
tab:4
**在B处失配，所以字符串为"ABCDA(!B)"，虽然P[5]的真前缀中有"A"和"A"匹配，但是匹配的下一个字符都是B，所以要找next[next[5]]=next[1]=0，对应A，和失配的B不相同，所以改进的next[5]=next[1]=0**
![](Images/Pasted%20image%2020240919214321.png)
````
## 13-D BM
### 13-D2 BC 策略
